...
let letra = "";
do {
  numeroDNI = parseInt(prompt("ingrese un numero"));
  if (isNaN(numeroDNI) === false) {
...
} while (numeroDNI < 0 || numeroDNI > 99999999 || isNaN(numeroDNI) === true);
document.write("la letra correspondiente a su DNI es <br>", letra);
